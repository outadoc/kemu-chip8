...
class Chip8InstructionDecoder {
    ...
    fun parse(i: Short): Chip8Instruction {
        ...
        val a2 = (a shr 3 * 4).toByte()
        val b2 = (b shr 2 * 4).toByte()
        val c2 = (c shr 1 * 4).toByte()
        val d2 = d.toByte()
        ...
        return when {
            ...
            a2 == 0x3.b -> skeq(x = b2, nn = (c or d).toByte())
            a2 == 0x4.b -> skne(x = b2, nn = (c or d).toByte())
            a2 == 0x5.b && d2 == 0x0.b -> skeq2(x = b2, y = c2)
            a2 == 0x6.b -> mov(x = b2, nn = (c or d).toByte())
            a2 == 0x7.b -> add(x = b2, nn = (c or d).toByte())
            ...
            a2 == 0xC.b -> rand(x = b2, nn = (c or d).toByte())
